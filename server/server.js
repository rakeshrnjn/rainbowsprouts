...
if (!process.env.GEMINI_API_KEY) {
	console.error(
		"❌ Error: GEMINI_API_KEY is missing. Please check server/.env",
	);
}
...
app.post("/api/chat", async (req, res) => {
	...
	try {
		...
		if (action === "quizStart") {
			prompt = `You are a friendly career coach for kids and teenagers. A young person whose age is ${age} wants to become: "${career}".
...
Return ONLY valid JSON:
{"summary": "2-3 encouraging sentences", "scores": {"skill1": 0-10, "skill2": 0-10, "skill3": 0-10, "skill4": 0-10,"skill5": 0-10,"skill6": 0-10,"skill7": 0-10,"skill8": 0-10,"skill9": 0-10,"skill10": 0-10}, "roadmap": ["step1", "step2", "step3", "step4", "step5", "step6"]}.
